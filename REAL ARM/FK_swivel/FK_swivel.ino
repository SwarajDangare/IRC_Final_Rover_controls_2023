...
void setup() 
{
  ...
  arm_pid[0].setParams(1, 0, 0, 255, 0); //swl
  arm_pid[1].setParams(1, 0, 0, 255, 0); //L1
  arm_pid[2].setParams(1, 0, 0, 255, 0); //L2
...
void SerialDisplay(int swivel, int pitch1, int pitch2, int dir1, int pwm1, int dir2, int pwm2)
{
  Serial.print("Swivel= ");
  Serial.print(swivel);
