...
def main():
    # Set the width and height of the screen (width, height), and name the
    # window.
            ...
            while not done:
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.JOYDEVICEADDED:
                        ...
                        # joystick, filling up the list without needing to create them
                        # manually.
                ...
                text_print.tprint(
                    screen, f"Number of joysticks: {joystick_count}")
                text_print.indent()
                ...
                for joystick in joysticks.values():
                    ...
                    text_print.tprint(
                        screen, f"Joystick's power level: {power_level}")
                    ...
                    for i in range(axes):
                        axis = joystick.get_axis(i)
                        text_print.tprint(
                            screen, f"Axis {i} value: {axis:>6.3f}")
                    text_print.unindent()
                    ...
                    for i in range(buttons):
                        ...
                        text_print.tprint(
                            screen, f"Button {i:>2} value: {button}")
                    text_print.unindent()
